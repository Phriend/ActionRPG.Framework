...
//		src << output("Welcome to the my sandbox!","output")
...
*/
		...
		class = prompt("What character race would you like to be?", "Human")

		set_pos(320, 325, 60, 1)//loc = locate(17, 35, 1)
		camera.pixel_x = 24
	...
	Login()
		...
		music('music.xm')
		src << output("Welcome to the my sandbox!","output")
		world << output("[client.key] has logged in.","ouput")
		world << output("","output")
