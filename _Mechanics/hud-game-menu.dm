...
/*					spawn()
						...
						owner.activate()
						owner.clear_hud()
						owner.init_hud() - These don't work apparently look below for what it should do */
...
/*					spawn()
						...
						owner.activate()
						owner.clear_hud()
						owner.init_hud() - basically reinitializing all the huds so their datums show() in the right pos*/
