...
HealthMeter
	...
	New(mob/m)
		...
		pos(8, m.client.VIEW_HEIGHT * Constants.ICON_HEIGHT - 24)
...
ManaMeter
	...
	New(mob/m)
		...
		pos(8, m.client.VIEW_HEIGHT * Constants.ICON_HEIGHT - 40)
